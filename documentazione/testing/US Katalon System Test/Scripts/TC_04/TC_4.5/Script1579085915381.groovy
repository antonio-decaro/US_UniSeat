...
WebUI.click(findTestObject('Page_UniSeat - Edificio F3/button_Prenota Aula'))

WebUI.setText(findTestObject('Page_UniSeat - Edificio F3/input_Durata prenotazione_durata'), '2')
