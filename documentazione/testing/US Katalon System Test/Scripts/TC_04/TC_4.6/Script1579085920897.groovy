...
WebUI.click(findTestObject('Object Repository/Page_UniSeat - Edificio F3/button_Prenota Aula'))

WebUI.setText(findTestObject('Page_UniSeat - Edificio F3/input_ora'), '15:00')
