...
WebUI.setText(findTestObject('Page_Profilo/inputPassword'), 'mariorossi')

WebUI.setText(findTestObject('Page_Profilo/inputConfPassword'), 'MarioRossi12')
...
expected = 'Il campo Password non rispetta il formato'
