...
WebUI.setText(findTestObject('Object Repository/Page_Profilo/input_Impostazioni_nome'), 'abcdefghilmnopqrstuvz')

WebUI.click(findTestObject('Object Repository/Page_Profilo/button_Conferma'))

actual = WebUI.getText(findTestObject('Object Repository/Page_Profilo/h6_Il campo Nome non rispetta la lunghezza'))

expected = "Il campo Nome non rispetta la lunghezza"
