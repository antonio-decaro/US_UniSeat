...
WebUI.setText(findTestObject('Object Repository/Page_Profilo/input_Impostazioni_nome'), 'Mar10')

WebUI.click(findTestObject('Object Repository/Page_Profilo/button_Conferma'))

actual = WebUI.getText(findTestObject('Object Repository/Page_Profilo/h6_Il campo Nome non rispetta il formato'))

expected = 'Il campo Nome non rispetta il formato'
