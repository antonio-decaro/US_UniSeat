...
WebUI.click(findTestObject('Object Repository/Page_Profilo/div_Nome                                   _0134cf'))

WebUI.setText(findTestObject('Object Repository/Page_Profilo/input_Nome_cognome'), 'Verdi')
...
actual = WebUI.getText(findTestObject('Object Repository/Page_Profilo/input_Nome_cognome'))
