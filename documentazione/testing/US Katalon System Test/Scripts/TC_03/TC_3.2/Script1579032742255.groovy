...
WebUI.navigateToUrl('http://localhost:8080/PrenotaPostoServlet?edificio=F3')

actual = WebUI.getText(findTestObject('Object Repository/Page_/pre_Aula non valida'))

expected = "Aula non valida"
