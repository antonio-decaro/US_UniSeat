...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Accedi_email'), 'abcdefghilmnopqrstuvz1234567890@studenti.unisa.it')

WebUI.click(findTestObject('Object Repository/Page_Login/label_Password'))

WebUI.setText(findTestObject('Object Repository/Page_Login/input_E-Mail_password'), 'MarioRossi12')
...
expected = "Il campo email non rispetta la lunghezza"
